...
@section('title', 'Tambah Nama Jabatan Referensi')
@section('page-title', 'Tambah Nama Jabatan Referensi')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="max-w-lg mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.nama-jabatan-referensi.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="jenis_jabatan" id="jenis_jabatan"
                        ...
                        @foreach($jenisOptions as $jenis)
                            <option value="{{ $jenis }}" {{ old('jenis_jabatan') == $jenis ? 'selected' : '' }}>
                                {{ $jenis }}
                            </option>
                        @endforeach
                    </select>
