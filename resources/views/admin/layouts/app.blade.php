...
<body class="h-full" x-data="{ sidebarOpen: false }">
    <div class="min-h-screen flex">
        <!-- Sidebar -->
        <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform lg:translate-x-0 flex-shrink-0 flex flex-col"
             style="transition-property: transform; transition-duration: 300ms; transition-timing-function: cubic-bezier(0.2, 0, 0, 1);"
            ...
            <nav class="px-4 py-6 space-y-1 flex-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.nama-jabatan-referensi.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.nama-jabatan-referensi.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:bg-gray-50' }}">
                    <span class="iconify" data-icon="mdi:format-list-bulleted" data-width="20" data-height="20"></span>
                    <span class="font-medium">Kelola Nama Jabatan</span>
                </a>
                ...
                <a href="{{ route('admin.bezetting.index') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('admin.bezetting.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:bg-gray-50' }}">
                    <span class="iconify" data-icon="mdi:gauge" data-width="20" data-height="20"></span>
                    <span class="font-medium">B & K</span>
                </a>
            ...
            <div class="p-4 border-t border-gray-200 bg-gray-50 flex-shrink-0">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-gradient-to-br from-primary-600 to-primary-700 rounded-full flex items-center justify-center text-white font-semibold">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            selects.forEach(function(selectElement) {
                ...
                // Skip selects inside Alpine.js x-data components
                if (selectElement.closest('[x-data]')) {
                    return;
                }
