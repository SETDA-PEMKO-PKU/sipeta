...
class AnalyticsController extends Controller
{
    ...
    /**
     * API endpoint for sidebar bezetting & kebutuhan per jabatan
     */
    public function getSidebarBezetting()
    {
        $accessibleOpdIds = $this->getAccessibleOpdIds();
        $data = $this->analyticsService->getSidebarBezettingData($accessibleOpdIds);
