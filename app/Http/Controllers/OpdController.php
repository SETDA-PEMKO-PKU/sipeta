...
class OpdController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('opds.show', compact('opd', 'namaReferensi', 'jenisOptions'));
    }
    ...
    {
        $jenisValid = implode(',', \App\Models\NamaJabatanReferensi::jenisOptions());
        $request->validate([
            'nama' => 'required|string|max:255',
            'jenis_jabatan' => 'required|in:' . $jenisValid,
